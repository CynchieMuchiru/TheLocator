package strathmore.com.thelocator.login;
...
import strathmore.com.thelocator.SignUpActivity;
...
public class LoginPage extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.emailaddress);
        ...
        text.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent next = new Intent(LoginPage.this, SignUpActivity.class);
                startActivity(next);
